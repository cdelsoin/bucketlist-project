...
/***/ function(module, exports, __webpack_require__) {
	...
	var entriesEvents = __webpack_require__(4);
	var viewLanding = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onIndexEntries = function onIndexEntries() {
	  var data = getFormFields(this);
	  // event.preventDefault();  // will need preventDefault if using a submit btn
	  api.indexEntries(data).done(ui.indexEntriesSuccess).fail(ui.failure);
	};

	var onIndexCompleteEntries = function onIndexCompleteEntries() {
	  var data = getFormFields(this);
	  // event.preventDefault();  // will need preventDefault if using a submit btn
	  api.indexCompleteEntries(data).done(ui.indexCompleteEntriesSuccess).fail(ui.failure);
	};

	var onShowEntries = function onShowEntries() {
	  var data = getFormFields(this);
	  // event.preventDefault();  // will need preventDefault if using a submit btn
	  api.showEntries(data).done(ui.showEntriesSuccess).fail(ui.failure);
	};

	var onShowCompleteEntries = function onShowCompleteEntries() {
	  var data = getFormFields(this);
	  // event.preventDefault();  // will need preventDefault if using a submit btn
	  api.showCompleteEntries(data).done(ui.showCompleteEntriesSuccess).fail(ui.failure);
	};
	...
	var onCreateEntry = function onCreateEntry(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.createEntry(data).done(ui.success).fail(ui.failure);
	};

	var onPatchEntry = function onPatchEntry(id) {
	  var isCompleted = true;
	  api.patchEntry(id, isCompleted).done(ui.patchSuccess(id)).fail(ui.failure);
	};

	var onDeleteEntry = function onDeleteEntry(id) {
	  api.deleteEntry(id).done(ui.success).fail(ui.failure);
	};
	...
	module.exports = {
	  ...
	  onIndexEntries: onIndexEntries,
	  onShowEntries: onShowEntries,
	  onPatchEntry: onPatchEntry,
	  onDeleteEntry: onDeleteEntry,
	  onShowCompleteEntries: onShowCompleteEntries,
	  onIndexCompleteEntries: onIndexCompleteEntries
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	//gets all entries
	var indexEntries = function indexEntries() {
	  return $.ajax({
	    url: app.api + '/entries/',
	    method: 'GET'
	  });
	...
	var indexCompleteEntries = function indexCompleteEntries() {
	  return $.ajax({
	...
	var showEntries = function showEntries() {
	  return $.ajax({
	...
	var showCompleteEntries = function showCompleteEntries() {
	  return $.ajax({
	...
	var createEntry = function createEntry(data) {
	  var file = data.image.file.split('\\')[2];
	  return $.ajax({
	    url: app.api + '/entries/',
	    method: 'POST',
	    headers: {
	...
	var patchEntry = function patchEntry(id, isCompleted) {
	  return $.ajax({
	...
	module.exports = {
	  ...
	  showCompleteEntries: showCompleteEntries,
	  indexCompleteEntries: indexCompleteEntries
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports) {
	...
	var app = {
	  api: 'https://bubble-bucket-api.herokuapp.com'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var patchSuccess = function patchSuccess(id) {
	  console.log(id);
	  $('.' + id).addClass('completed-goals');
	};

	//launch handlebar template that displays all goals
	var indexEntriesSuccess = function indexEntriesSuccess(data) {
	  $('.entries-container').html('');

	  var viewIndexEntries = __webpack_require__(9);
	...
	var indexCompleteEntriesSuccess = function indexCompleteEntriesSuccess(data) {
	  $('.entries-container').html('');

	  var viewIndexCompleteEntries = __webpack_require__(29);
	...
	var showEntriesSuccess = function showEntriesSuccess(data) {
	  $('.entries-container').html('');

	  var viewShowEntries = __webpack_require__(30);
	...
	var showCompleteEntriesSuccess = function showCompleteEntriesSuccess(data) {
	  $('.entries-container').html('');

	  var viewShowCompleteEntries = __webpack_require__(31);
	...
	module.exports = {
	  success: success,
	  failure: failure,
	  indexEntriesSuccess: indexEntriesSuccess,
	  showEntriesSuccess: showEntriesSuccess,
	  patchSuccess: patchSuccess,
	  showCompleteEntriesSuccess: showCompleteEntriesSuccess,
	  indexCompleteEntriesSuccess: indexCompleteEntriesSuccess
	  // uploadImageSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class = \"image-each-entry\">\n  <div class=\"index-each-entry\">\n    <h4>  "
	    ...
	    + "\" id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"circleModalLabel\">\n          <img class=\"img-responsive-height\" src=\"https://jordanallain.s3.amazonaws.com/"
	    + alias4(((helper = (helper = helpers.url || (depth0 != null ? depth0.url : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"url","hash":{},"data":data}) : helper)))
	    + "\">\n  </div>\n\n  <style>\n    .gray-btn {\n      color: #000;\n    }\n\n    img {\n      min-width: 20px !important;\n    }\n\n    .img-responsive-height\n    {\n      display: block;\n      width: auto;\n      max-height: 60%;\n      margin: 50px auto;\n    }\n  </style>\n  </div>\n</div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.entries : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class = \"image-completed-entry\">\n  <div class=\"index-all-completed\">\n        <h4>  "
	    + alias4(((helper = (helper = helpers.goal || (depth0 != null ? depth0.goal : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"goal","hash":{},"data":data}) : helper)))
	    + " </h4>\n        <h5> "
	    + alias4(((helper = (helper = helpers.description || (depth0 != null ? depth0.description : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"description","hash":{},"data":data}) : helper)))
	    + " </h5>\n        <h5> "
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class = \"image-show-entry "
	    ...
	    + " </h5>\n  <h5> "
	    + alias4(((helper = (helper = helpers.location || (depth0 != null ? depth0.location : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"location","hash":{},"data":data}) : helper)))
	    + " </h5>\n\n  <form class=\"complete-entry-form\" data-id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">\n    <input name=\"submit\" type=\"submit\" class=\"gray-btn complete-entry-btn-sm\" value=\"I did it!\">\n  </form>\n\n  <form class=\"delete-entry-form\" data-id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">\n    <input name=\"submit\" type=\"submit\" class=\"gray-btn delete-entry-btn-sm\" value=\"I gave up.. :(\">\n  </form>\n  <button type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#"
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">\n  View Image\n</button>\n</div>\n</div>\n<div class=\"modal fade "
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\" id=\""
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class = \"image-completed-entry "
	    ...
	    + " </h5>\n      <form class=\"delete-entry-form\" data-id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">\n        <input name=\"submit\" type=\"submit\" class=\"gray-btn delete-entry-btn-sm\" value=\"Remove\">\n      </form>\n      <button type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#"
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">\n      View Image\n    </button>\n    <div class=\"modal fade "
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\" id=\""
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "a21fd93665fb6ce64a9cacfb1565823c.png";
